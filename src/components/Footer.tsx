        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Creating unforgettable moments and exceptional experiences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-400">Destination Events</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-400">Email: contact@eventmaster.com</li>
            </ul>
          </div>
        </div>
