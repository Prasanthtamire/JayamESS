        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-4">
                {[
                  { name: 'Slack', description: 'Team communication', connected: true, logo: '💬' },
                  { name: 'Google Workspace', description: 'Email and calendar sync', connected: true, logo: '📧' },
                  { name: 'Microsoft Teams', description: 'Video conferencing', connected: false, logo: '📹' },
                  { name: 'Zoom', description: 'Video meetings', connected: false, logo: '🎥' },
                ].map((app) => (
